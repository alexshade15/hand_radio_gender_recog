...
# set name of job
#SBATCH --job-name=TrainVgg_Kfold

# mail alert at start, end and abortion of execution
#SBATCH --mail-type=ALL

# set an output file
#SBATCH --output Kfold_new1.dat
...
# run the application
srun singularity exec --bind /data/vlongoba:/data /data/sifs/tensorflow2.sif python 2r_new_kfold1.py
